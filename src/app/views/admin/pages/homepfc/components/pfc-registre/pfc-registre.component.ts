...
@Component({
  ...
  templateUrl: './pfc-registre.component.html',
  styleUrl: './pfc-registre.component.css',
})
export class PfcRegistreComponent {
  active = 1;
  ...
  openEditModalrv(content: any, el: any) {
    this.selected_data_reqrv = el;
    this.loading = false;
