...
import { NgbModalConfig, NgbModal, NgbOffcanvasConfig, NgbOffcanvas, NgbModule } from '@ng-bootstrap/ng-bootstrap';
...
import { VriComponent } from './Components/vri/vri.component';
import { VCNComponent } from './Components/vcn/vcn.component';
import { DAMComponent } from './Components/dam/dam.component';

@Component({
  selector: 'app-eservice-create',
  templateUrl: './eservice-create.component.html',
  ...
  styleUrls: ['./eservice-create.component.css']
})
export class EserviceCreateComponent {
...
code:any
  ...
  store(){
    this.settedFiles=this.requiredFiles.filter((res:any)=> res.isSetted==true);
    this.convertTobase64();
    this.myRequestForm.documents=this.settedFiles
      let formData= new FormData()
      console.log(this.myRequestForm)
      formData.append("datas",JSON.stringify(this.myRequestForm))
